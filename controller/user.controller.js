...
const cookieOptions = {
  ...
  secure: false, // Allow over HTTP (not HTTPS) – NOT secure, use only for local development
  httpOnly: false, // Allows access from JavaScript – not recommended, but workable
};
